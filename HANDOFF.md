...
Branch `session/brokerage-chart-full-2026-05-27` (pushed to origin,
**NOT merged** — see "blocked" note below). The first React brokerage
"polish" pass shipped structurally but looked/behaved wrong; this is
the real port. Each fix was verified live in chrome-devtools against
the **legacy SPA** (engine `:4000`) — they now match.
